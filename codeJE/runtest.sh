...
# Load utilities. /home/johannalomker/alice/serviceTask/Run3Analysisvalidation/codeJE/utilities.sh
source "$DIR_EXEC/../exec/utilities.sh" || { echo "Error: Failed to load utilities."; exit 1; }
