...
JSONRUN3="config.json"  # Run 3 tasks parameters
JSON="$JSONRUN3"
...
case $INPUT_CASE in
  ...
  11)
    ...
    ;;
  12)
    INPUT_LABEL="Run 2, p-p 13 TeV, LHC18/LHC18d/000285978/pass2/18000285978019.100 (ESD)"
    INPUT_DIR="/home/johannalomker/alice/serviceTask/data" # converted good AO2Ds
