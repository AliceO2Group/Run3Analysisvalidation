void Chi_c_PbPb5p52_absy0p33_results()
{
//=========Macro generated from canvas: canvas/A Simple Graph Example
//=========  (Mon Oct 18 11:29:41 2021) by ROOT version 6.20/08
   ...
   histosignf__2->SetBinContent(1,0.002476669);
   histosignf__2->SetBinContent(2,0.009938575);
   histosignf__2->SetBinContent(3,0.04946894);
   histosignf__2->SetBinContent(4,0.06270932);
   histosignf__2->SetBinContent(5,0.05432845);
   histosignf__2->SetBinContent(6,0.04456541);
   histosignf__2->SetBinContent(7,0.05860573);
   histosignf__2->SetBinContent(8,0.08683678);
   histosignf__2->SetBinContent(9,0.1293667);
   histosignf__2->SetBinContent(10,7.190311e-08);
